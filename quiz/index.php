...
<div class="row">
<div class="col-lg-6">
<span class="logo">I never Lose Either I win Or I learn </span></div>
...
<div class="form-group">
  ...
  <div class="col-md-12">
  <input id="rollno" name="rollno" placeholder="Enter your Schlolar no " class="form-control input-md" type="text" value="<?php
...
<a href="#" data-toggle="modal" data-target="#login" style="color:lightyellow">Creator Login</a></div>
<div class="col-md-3 box">
<span href="#" data-target="#login" style="color:lightyellow">Created By Pankaj<br><br></span>
</div>
